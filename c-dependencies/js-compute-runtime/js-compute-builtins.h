...
inline bool ThrowIfNotConstructing(JSContext *cx, const JS::CallArgs &args, const char *builtinName) {
...
typedef bool InternalMethod(JSContext *cx, JS::HandleObject receiver, JS::HandleValue extra, JS::CallArgs args);
