...
JSObject *create(JSContext *cx, JS::HandleObject stream, TransformAlgorithm *transformAlgo,
  ...
  JS::SetReservedSlot(controller, Slots::TransformAlgorithm, JS::PrivateValue((void *)transformAlgo));
 ...
 */
JSObject *InvokePromiseReturningCallback(JSContext *cx, JS::HandleValue receiver, JS::HandleValue callback,
 ...
 */
bool transformPromise_catch_handler(JSContext *cx, JS::HandleObject controller, JS::HandleValue extra,
                                    JS::CallArgs args) {
