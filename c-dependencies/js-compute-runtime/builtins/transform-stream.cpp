...
JSObject *backpressureChangePromise(JSObject *self) {
  MOZ_ASSERT(is_instance(self));
  return JS::GetReservedSlot(self, TransformStream::Slots::BackpressureChangePromise).toObjectOrNull();
}
...
bool constructor(JSContext *cx, unsigned argc, JS::Value *vp) {
  ...
  JS::RootedObject self(cx, create(cx, transformStreamInstance, writableHighWaterMark,
 ...
 */
bool default_sink_write_algo_then_handler(JSContext *cx, JS::HandleObject stream, JS::HandleValue chunk,
                                          JS::CallArgs args) {
...
bool DefaultSinkWriteAlgorithm(JSContext *cx, JS::CallArgs args, JS::HandleObject writableController,
...
bool DefaultSinkAbortAlgorithm(JSContext *cx, JS::CallArgs args, JS::HandleObject writableController,
                               JS::HandleObject stream, JS::HandleValue reason) {
  MOZ_ASSERT(is_instance(stream));
 ...
 */
bool default_sink_close_algo_then_handler(JSContext *cx, JS::HandleObject stream, JS::HandleValue extra,
                                          JS::CallArgs args) {
 ...
 */
bool default_sink_close_algo_catch_handler(JSContext *cx, JS::HandleObject stream, JS::HandleValue extra,
                                           JS::CallArgs args) {
...
bool DefaultSinkCloseAlgorithm(JSContext *cx, JS::CallArgs args, JS::HandleObject writableController,
...
bool SetBackpressure(JSContext *cx, JS::HandleObject stream, bool backpressure) {
  ...
  JS::SetReservedSlot(stream, TransformStream::Slots::BackpressureChangePromise, JS::ObjectValue(*changePromise));
...
bool Initialize(JSContext *cx, JS::HandleObject stream, JS::HandleObject startPromise,
  ...
  JS::RootedObject readable(cx, JS::NewReadableDefaultStreamObject(cx, source, readableSizeAlgorithm,
