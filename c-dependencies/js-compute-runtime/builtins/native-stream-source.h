...
typedef bool PullAlgorithm(JSContext *cx, JS::CallArgs args, JS::HandleObject stream, JS::HandleObject owner,
                           JS::HandleObject controller);
typedef bool CancelAlgorithm(JSContext *cx, JS::CallArgs args, JS::HandleObject stream, JS::HandleObject owner,
                             JS::HandleValue reason);

JSObject *create(JSContext *cx, JS::HandleObject owner, JS::HandleValue startPromise, PullAlgorithm *pull,
...
void set_stream_piped_to_ts_writable(JSContext *cx, JS::HandleObject stream, JS::HandleObject writable);
} // namespace NativeStreamSource
#endif