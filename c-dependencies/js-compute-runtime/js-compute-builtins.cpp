...
#define CLASS_BOILERPLATE_CUSTOM_INIT(cls)                                                         \
  ...
  bool check_receiver(JSContext *cx, HandleValue receiver, const char *method_name) {              \
    ...
    return true;                                                                                   \
                                                                                                   ...
                                                                                                   \
  bool init_class_impl(JSContext *cx, HandleObject global, HandleObject parent_proto = nullptr) {  \
...
#define CLASS_BOILERPLATE(cls)                                                                     \
  CLASS_BOILERPLATE_CUSTOM_INIT(cls)                                                               \
                                                                                                   \
  bool init_class(JSContext *cx, HandleObject global) { return init_class_impl(cx, global); }
