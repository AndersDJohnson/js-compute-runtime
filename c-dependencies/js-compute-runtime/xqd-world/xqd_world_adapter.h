...
fastly_error_t xqd_fastly_http_body_read(fastly_body_handle_t h, uint32_t chunk_size, fastly_list_u8_t *ret);
fastly_error_t xqd_fastly_http_body_write(fastly_body_handle_t h, fastly_list_u8_t *buf, fastly_body_write_end_t end, uint32_t *ret);
fastly_error_t xqd_fastly_http_body_close(fastly_body_handle_t h);
fastly_error_t xqd_fastly_log_endpoint_get(xqd_world_string_t *name, fastly_log_endpoint_handle_t *ret);
...
fastly_error_t xqd_fastly_http_req_cache_override_set(fastly_request_handle_t h, fastly_http_cache_override_tag_t tag, fastly_option_u32_t *ttl, fastly_option_u32_t *stale_while_revalidate, fastly_option_string_t *sk);
...
fastly_error_t xqd_fastly_http_req_header_remove(fastly_request_handle_t h, xqd_world_string_t *name);
fastly_error_t xqd_fastly_http_req_method_get(fastly_request_handle_t h, xqd_world_string_t *ret);
fastly_error_t xqd_fastly_http_req_method_set(fastly_request_handle_t h, xqd_world_string_t *method);
...
fastly_error_t xqd_fastly_http_req_version_get(fastly_request_handle_t h, fastly_http_version_t *ret);
fastly_error_t xqd_fastly_http_req_version_set(fastly_request_handle_t h, fastly_http_version_t version);
fastly_error_t xqd_fastly_http_req_send(fastly_request_handle_t h, fastly_body_handle_t b, xqd_world_string_t *backend, fastly_response_t *ret);
fastly_error_t xqd_fastly_http_req_send_async(fastly_request_handle_t h, fastly_body_handle_t b, xqd_world_string_t *backend, fastly_pending_request_handle_t *ret);
fastly_error_t xqd_fastly_http_req_send_async_streaming(fastly_request_handle_t h, fastly_body_handle_t b, xqd_world_string_t *backend, fastly_pending_request_handle_t *ret);
fastly_error_t xqd_fastly_http_req_pending_req_poll(fastly_pending_request_handle_t h, fastly_option_response_t *ret);
fastly_error_t xqd_fastly_http_req_pending_req_wait(fastly_pending_request_handle_t h, fastly_response_t *ret);
fastly_error_t xqd_fastly_http_req_pending_req_select(fastly_list_pending_request_handle_t *h, fastly_tuple2_u32_response_t *ret);
...
fastly_error_t xqd_fastly_http_req_auto_decompress_response_set(fastly_request_handle_t h, fastly_content_encodings_t encodings);
...
fastly_error_t xqd_fastly_http_resp_header_remove(fastly_response_handle_t h, xqd_world_string_t *name);
fastly_error_t xqd_fastly_http_resp_version_get(fastly_response_handle_t h, fastly_http_version_t *ret);
fastly_error_t xqd_fastly_http_resp_version_set(fastly_response_handle_t h, fastly_http_version_t version);
fastly_error_t xqd_fastly_http_resp_send_downstream(fastly_response_handle_t h, fastly_body_handle_t b, bool streaming);
fastly_error_t xqd_fastly_http_resp_status_get(fastly_response_handle_t h, fastly_http_status_t *ret);
fastly_error_t xqd_fastly_http_resp_status_set(fastly_response_handle_t h, fastly_http_status_t status);
fastly_error_t xqd_fastly_http_resp_close(fastly_response_handle_t h);
fastly_error_t xqd_fastly_http_resp_framing_headers_mode_set(fastly_response_handle_t h, fastly_framing_headers_mode_t mode);
fastly_error_t xqd_fastly_dictionary_open(xqd_world_string_t *name, fastly_dictionary_handle_t *ret);
fastly_error_t xqd_fastly_dictionary_get(fastly_dictionary_handle_t h, xqd_world_string_t *key, xqd_world_string_t *ret);
...
fastly_error_t xqd_fastly_kv_lookup(fastly_kv_store_handle_t store, fastly_list_u8_t *key, fastly_body_handle_t *ret);
fastly_error_t xqd_fastly_kv_insert(fastly_kv_store_handle_t store, fastly_list_u8_t *key, fastly_body_handle_t body_handle, uint32_t max_age, bool *ret);
fastly_error_t xqd_fastly_object_store_open(xqd_world_string_t *name, fastly_object_store_handle_t *ret);
fastly_error_t xqd_fastly_object_store_lookup(fastly_object_store_handle_t store, xqd_world_string_t *key, fastly_body_handle_t *ret);
fastly_error_t xqd_fastly_object_store_lookup_as_fd(fastly_object_store_handle_t store, xqd_world_string_t *key, fastly_fd_t *ret);
